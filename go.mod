...
require (
	...
	k8s.io/apiextensions-apiserver v0.0.0-20181121194223-80aa1ff92762 // indirect
	k8s.io/apimachinery v0.0.0-20190211022232-e355a776c090
	k8s.io/client-go v2.0.0-alpha.0.0.20190115175254-86dbf26d38ed+incompatible // indirect
